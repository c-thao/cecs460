...
//  File name: <transmit_test.v>                                  //
//                                                                //
//  Created by <Chou Thao> on <4/6/17>.                           //
//  Copyright © 2016 <Chou Thao>. All rights reserved.            //
//                                                                //
//  Abstract: <This is a testbench which checks to verify the     //
//             operation of a internal transmit engine.>          //
//                                                                //
...
module transmit_test;
	...
	initial begin
		...
		@(posedge clk)
		BAUD = 4'b1011; // fastest baud rate at 921600
