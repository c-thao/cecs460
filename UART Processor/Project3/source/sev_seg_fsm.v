...
module sev_seg_fsm(clk, rst, d_in, d_out, anode);
   ...
   // dependent on a 4 bit register
	...
	always@(number)
	   case(number)
		   4'h0: out_next = 7'b0000001;
		   4'h1: out_next = 7'b1001111;
		   4'h2: out_next = 7'b0010010;
		   4'h3: out_next = 7'b0000110;
		   4'h4: out_next = 7'b1001100;
		   4'h5: out_next = 7'b0100100;
		   4'h6: out_next = 7'b0100000;
		   4'h7: out_next = 7'b0001101;
		   4'h8: out_next = 7'b0000000;
		   4'h9: out_next = 7'b0001100;
		   4'hA: out_next = 7'b0001000;
		   4'hB: out_next = 7'b1100000;
		   4'hC: out_next = 7'b0110001;
		   4'hD: out_next = 7'b1000010;
		   4'hE: out_next = 7'b0110000;
		   4'hF: out_next = 7'b0111000;
		endcase
